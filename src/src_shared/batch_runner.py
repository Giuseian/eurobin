...
#         # images è opzionale:
#         # - se manca -> scenario testuale
#         # - se è [] -> scenario testuale
#         # - se esiste -> deve essere una lista
#         if images is None:
#             images = []
...
#         # Se non ci sono immagini, eseguiamo comunque un run passando image_path=None
...
#                                 image_path=image_path,  # può essere None
#                                 task_text=task_text,

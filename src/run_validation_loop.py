    ...
    while not task_completed:
        ...
        try:
            ...
            for stage in stages:
                ...
                # --------------------------------------------------
                # In the future, replace this block with the actual deploy call:
                #
                # deploy_stage(stage)
                # next_image = capture_current_frame()
                #
                # For now we use a predefined offline image sequence.
...
#                     if replans_done > args.max_replans:
#                         raise RuntimeError(
#                             f"Maximum number of replans exceeded ({args.max_replans})."
#                         )

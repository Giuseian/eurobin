    ...
    while not task_completed:
        ...
        try:
            ...
            cycle_record["outcome"] = (
                f"preconditions_{pre_response['overall_status']}_stage_{stage_id}"
            )
            ...
            full_summary["current_stage_overall_status"] = pre_response["overall_status"]
            full_summary["final_image_path"] = str(Path(current_image).resolve())

            # The pipeline currently ends here: no deployment and no post-validation.
            task_completed = True

...
def get_validator_prompt_cycle_dir(
    ...
    if condition_kind not in VALID_VALIDATOR_CONDITION_KINDS:
        allowed = ", ".join(sorted(VALID_VALIDATOR_CONDITION_KINDS))
        raise ValueError(
            f"Invalid validator condition_kind '{condition_kind}'. "

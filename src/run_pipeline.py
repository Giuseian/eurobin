...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description=(
            ...
            "scene_description -> scene_description_full -> vlm_planning -> simultaneous_actions"
        )
    )
...
### run_pipeline.py ORIGINAL without scene_enrichment
...
# def build_parser() -> argparse.ArgumentParser:
#     parser = argparse.ArgumentParser(
#         description="Run the full robotic VLM pipeline: scene_description -> vlm_planning -> simultaneous_actions"
#     )

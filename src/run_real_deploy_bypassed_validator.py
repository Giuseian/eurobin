...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description=(
            "Run the real deploy pipeline with bypassed validator, scene grounding, "
            "integrated screenshots, and forced validator matching."
        )
    )
    ...
    parser.add_argument(
        ...
        default="screens",
        help=(
            "Subdirectory name used inside the "
            "real_deploy_pipeline_bypassed_validator scenario folder for screenshots."
        ),
    )
...
def get_screens_root(
    ...
    return (
        ...
        / "scenarios"
        / "real_deploy_pipeline_bypassed_validator"
        / scenario_name
        / loop_timestamp
        / screens_subdir
    )
...
def load_scene_object_list_from_run(
    settings,
    scenario_name: str,
    scene_version: str,
...
def save_validator_outputs(
    ...
    run_info = {
        "module": "validator",
        "execution_mode": "real_deploy_pipeline_bypassed_validator_forced_matching",
...
def execute_forced_validator_step(
    ...
    scene_object_list = load_scene_object_list_from_run(
        settings=settings,
...
def execute_scene_description_step(
    ...
    parsed_path, run_info_path = save_module_outputs(
        ...
        parsed_response=parsed_response,
        execution_mode="real_deploy_pipeline_bypassed_validator",
        dependencies=None,
...
def execute_scene_description_full_step(
    ...
    parsed_path, run_info_path = save_scene_description_full_artifact(
        ...
        safety_threshold=safety_threshold,
        include_debug_mapping=include_debug_mapping,
        execution_mode="real_deploy_pipeline_bypassed_validator_side_artifact",
    )
...
def main() -> None:
    ...
    summary: dict[str, Any] = {
        "module": "real_deploy_pipeline_bypassed_validator",
        "scenario_name": args.scenario,
        "loop_timestamp": loop_timestamp,
        "timestamp": datetime.now().isoformat(),
    ...
    print("\n======================================================")
    print("REAL DEPLOY PIPELINE BYPASSED VALIDATOR STARTED")
    ...
    print("\n======================================================")
    print("REAL DEPLOY PIPELINE BYPASSED VALIDATOR COMPLETED")
    print(f"Scenario:        {args.scenario}")
...
#         safety_threshold=safety_threshold,
#         include_debug_mapping=include_debug_mapping,
#         execution_mode="real_deploy_bypassed_validator_side_artifact",
#     )

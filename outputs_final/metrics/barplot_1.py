...
# Testi
title = "Module Reliability"
y_label = "Success Rate (%)"

# Nome file di output
output_filename = "module_reliability.pdf"
...
proposed = [91, 95, 99, 93]
baseline = [68, 72, 81, 93]
...
ax.set_xticks(x)
ax.set_xticklabels(modules, fontsize=tick_fontsize)

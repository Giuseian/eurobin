...
class CentauroCameraGraspCheck(Node):
    ...
    def read_input_poses(self):
        ...
        self.box_position = self.camera_position_to_robot_base(self.object_position_camera)
    ...
    def print_check_report(self, phases):
        ...
        print(f'Frame base       : {self.base_frame}')
        ...
        print('-' * 78)
        print('POSIZIONI DAGANA RISPETTO AL FRAME BASE/PELVIS')

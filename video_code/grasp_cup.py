...
class SingleDaganaGlassReach(Node):
    ...
    def compute_phase_offsets(self):
        """
        Calcola:
        - PHASE 1: allineamento x e y del dagana_2 rispetto al glass
                   + rotazione di +90 gradi rispetto a x
        - PHASE 2: allineamento z del dagana_2 rispetto al glass
        ...
        # PHASE 1: align X and Y
        phase1_dx = target_x - dag_x + 0.02
        phase1_dy = target_y - dag_y
        phase1_dz = (target_z - dag_z + 0.2)/2

        # PHASE 2: align Z
        phase2_dx = 0.0
        phase2_dy = 0.0
        phase2_dz = (target_z - dag_z + 0.2)/2
    ...
    def execute(self):
        ...
        # =====================================================
        # PRE-ROTATION
        # Solita prerotazione del grasp box per dagana_2
        # =====================================================
        ...
        self.run_phase(
            ...
            *phases['phase1_xy_rot'],
            #qx=0.70710678, qy=0.0, qz=0.0, qw=0.70710678,      # 90 gradi
            qx=0.76604444, qy=0.0, qz=0.0, qw=0.64278761,       # 100 gradi
